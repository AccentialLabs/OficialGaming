                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            ...
                            <div class="col-md-12 linha">
                                <div class="col-md-12">
                                    <input type="checkbox" id="respdescritiva" name="tipo_resposta" value="DESCRITIVA"><span class="auto-small"> Meta geral(para todos os Usuários/Jogadores cadastrados)</span>
                                </div>
                            </div>

                            <div class="col-md-12 linha">
                                <div class="col-md-6">
                                    <input type="checkbox" id="respdescritiva" name="tipo_resposta" value="DESCRITIVA"><span class="auto-small"> Meta por Usuário/Jogador</span><br/>
                                    <input type="checkbox" id="respdescritiva" name="tipo_resposta" value="DESCRITIVA"><span class="auto-small"> Meta por Equipe</span>
                                </div>
